...
ray job submit --runtime-env-json='{"working_dir": "./", "pip": ["python-dotenv", "torchinfo"], "env_vars": {"APPLICATION_HOST": "'$APPLICATION_HOST'", "MODELREG_PORT": "'$MODELREG_PORT'", "BACKEND_PORT": "'$BACKEND_PORT'"}}' -- python3 -m synthetic_data.mlops.train_gan_gp
